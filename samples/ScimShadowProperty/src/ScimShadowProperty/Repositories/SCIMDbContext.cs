...
using ScimShadowProperty.Repositories.Configurations;
...
namespace ScimShadowProperty.Repositories
{
    public class SCIMDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) => Init(modelBuilder);

        protected virtual void Init(ModelBuilder modelBuilder)
        {
