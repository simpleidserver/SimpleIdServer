...
public static class AuthenticationBuilderExtensions
{
    ...
    public static AuthenticationBuilder AddSamlSp(this AuthenticationBuilder builder, string authenticationScheme, string displayName, Action<SamlSpOptions> configureOptions)
    {
        ...
        else builder.Services.Configure<SamlSpOptions>((opt) => { });
        builder.Services.TryAddEnumerable(ServiceDescriptor.Singleton<IPostConfigureOptions<SamlSpOptions>, SamlSpOptionsPostConfigureOptions>());
