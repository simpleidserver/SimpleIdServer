...
task pack -depends release, compile, buildTemplate {
	...
	exec { dotnet pack $source_dir\IdServer\SimpleIdServer.IdServer.Webauthn\SimpleIdServer.IdServer.Webauthn.csproj -c $config --no-build $versionSuffix --output $result_dir }
