    ...
    public static Template DefaultTemplate
    {
        get
        {
            return TemplateBuilder.New(Name, isActive: true)
                ...
                .SetPasswordFieldClasses("rz-form-field rz-variant-outlined rz-floating-label fullWidth", string.Empty, string.Empty, "viewPasswordContainer", "viewPasswordBtn")
