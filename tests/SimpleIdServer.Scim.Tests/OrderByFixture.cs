...
namespace SimpleIdServer.Scim.Tests
{
    public class OrderByFixture
    {
        ...
        public void When_Parse_And_Execute_OrderBy()
        {
            ...
            Assert.Equal("Justine", firstResult.ElementAt(0).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("bjensen", firstResult.ElementAt(1).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("bjensen", secondResult.ElementAt(0).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("Justine", secondResult.ElementAt(1).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("bjensen", thirdResult.ElementAt(0).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("Justine", thirdResult.ElementAt(1).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("Justine", fourthResult.ElementAt(0).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("bjensen", fourthResult.ElementAt(1).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("Justine", firthResult.ElementAt(0).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("bjensen", firthResult.ElementAt(1).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("bjensen", sixResult.ElementAt(0).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
            Assert.Equal("Justine", sixResult.ElementAt(1).Attributes.First(a => a.SchemaAttribute.Name == "userName").ValuesString.First());
        }
