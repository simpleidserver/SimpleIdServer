...
public class IdServerConfiguration
{
    ...
    {
        var result = Constants.DefaultScopes.Role;
    ...
    private static Client FiftySixClient = ClientBuilder.BuildUserAgentClient("fiftySixClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role).Build();
    ...
    public static List<Scope> Scopes => new List<Scope>
    {
        ...
        Constants.DefaultScopes.OpenIdScope,
        Constants.DefaultScopes.Profile,
        GetRoleScope(),
        Constants.DefaultScopes.Email,
        Constants.DefaultScopes.OfflineAccessScope,
        Constants.DefaultScopes.GrantManagementQuery,
        Constants.DefaultScopes.GrantManagementRevoke,
        Constants.DefaultScopes.Users,
        Constants.DefaultScopes.Register,
    ...
    public static List<Client> Clients = new List<Client>
        {
            ...
            ClientBuilder.BuildUserAgentClient("fourteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email, DefaultScopes.Address).Build(),
            ClientBuilder.BuildUserAgentClient("fifteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).DisableIdTokenSignature().Build(),
            ClientBuilder.BuildUserAgentClient("sixteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.EcdsaSha256).Build(),
            ClientBuilder.BuildUserAgentClient("seventeenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.EcdsaSha384).Build(),
            ClientBuilder.BuildUserAgentClient("eighteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.EcdsaSha512).Build(),
            ClientBuilder.BuildUserAgentClient("nineteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.HmacSha256).Build(),
            ClientBuilder.BuildUserAgentClient("twentyClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.HmacSha384).Build(),
            ClientBuilder.BuildUserAgentClient("twentyOneClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.HmacSha512).Build(),
            ClientBuilder.BuildUserAgentClient("twentyTwoClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.RsaSha256).Build(),
            ClientBuilder.BuildUserAgentClient("twentyThreeClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.RsaSha384).Build(),
            ClientBuilder.BuildUserAgentClient("twentyFourClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.RsaSha512).Build(),
            ClientBuilder.BuildUserAgentClient("twentyFiveClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes128CbcHmacSha256).AddEncryptedKey(ClientEncryptingCredentials["twentyFiveClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentySixClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes192CbcHmacSha384).AddEncryptedKey(ClientEncryptingCredentials["twentySixClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentySevenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes256CbcHmacSha512).AddEncryptedKey(ClientEncryptingCredentials["twentySevenClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentyEightClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes128CbcHmacSha256).AddEncryptedKey(ClientEncryptingCredentials["twentyEightClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentyNineClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes192CbcHmacSha384).AddEncryptedKey(ClientEncryptingCredentials["twentyNineClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("thirtyClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes256CbcHmacSha512).AddRSAEncryptedKey(new RsaSecurityKey(RSA.Create()) { KeyId = "keyId" }, SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes256CbcHmacSha512, SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyOneClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetRequestObjectSigning(SecurityAlgorithms.RsaSha256).EnableIdTokenInResponseType().AddSigningKey(ClientSigningCredentials["thirtyOneClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).Build(),
            ...
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyThreeClient", "password", null, "http://localhost:8080").AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetRequestObjectSigning(SecurityAlgorithms.RsaSha256).SetRequestObjectEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes128CbcHmacSha256).EnableIdTokenInResponseType().AddSigningKey(ClientSigningCredentials["thirtyThreeClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).SetPairwiseSubjectType("salt").Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyFourClient", "password", null, "http://localhost:8080").AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetDefaultMaxAge(2).EnableIdTokenInResponseType().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyFiveClient", "password", null, "http://localhost:8080").AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).EnableIdTokenInResponseType().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtySixClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email, DefaultScopes.OfflineAccessScope).EnableOfflineAccess().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtySevenClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyEightClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetUserInfoSignedResponseAlg().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyNineClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetUserInfoSignedResponseAlg().SetUserInfoEncryption().AddRSAEncryptedKey(new RsaSecurityKey(RSA.Create()) { KeyId = "keyId" }, SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes128CbcHmacSha256).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyOneClient", "password", null, "http://localhost:8080").AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).SetRequestObjectSigning(SecurityAlgorithms.EcdsaSha384).Build(),
            ...
            ClientBuilder.BuildTraditionalWebsiteClient("fortySixClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().EnableTokenInResponseType().EnableRefreshTokenGrantType().ResourceParameterIsRequired().AddScope(AdminScope, CalendarScope, Constants.DefaultScopes.OfflineAccessScope).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortySevenClient", "password", null, "http://localhost:8080").AddAuthDataTypes("secondDetails").UseClientSecretPostAuthentication().EnableTokenInResponseType().EnableRefreshTokenGrantType().AddScope(AdminScope, CalendarScope, Constants.DefaultScopes.OfflineAccessScope).EnableAccessToGrantsApi().DisableConsent().Build(),
            ...
            ClientBuilder.BuildUserAgentClient("fiftyFourClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Profile, DefaultScopes.Email).SetSigAuthorizationResponse(SecurityAlgorithms.RsaSha256).Build(),
            ...
            FiftySixClient,
            ClientBuilder.BuildApiClient("fiftySevenClient", "password").AddScope(DefaultScopes.Users).AddScope(DefaultScopes.Register).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fiftyEightClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().EnableTokenInResponseType().AddAuthDataTypes("openid_credential").DisableConsent().AddScope(DefaultScopes.GrantManagementQuery, DefaultScopes.GrantManagementRevoke).Build(),
            ...
            ClientBuilder.BuildApiClient("sixtyTwoClient", "password").AddScope(DefaultScopes.Acrs).Build(),
            ...
            ClientBuilder.BuildTraditionalWebsiteClient("seventyClient", "password", null, "http://localhost:8080").SetAccessTokenType(AccessTokenTypes.Reference).UseClientSecretPostAuthentication().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Role, DefaultScopes.Profile, DefaultScopes.Email).Build(),
            ...
            ClientBuilder.BuildTraditionalWebsiteClient("seventyFourClient", "password", null, "http://localhost:8080").DisableConsent().AddScope(DefaultScopes.OpenIdScope, DefaultScopes.Profile).Build(),
        };
