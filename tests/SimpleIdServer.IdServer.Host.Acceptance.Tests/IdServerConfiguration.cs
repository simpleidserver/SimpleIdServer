...
public class IdServerConfiguration
{
    ...
    {
        var result = SimpleIdServer.IdServer.Config.DefaultScopes.Role;
    ...
    private static Client FiftySixClient = ClientBuilder.BuildUserAgentClient("fiftySixClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role).Build();
    ...
    public static List<Scope> Scopes => new List<Scope>
    {
        ...
        GetRoleScope(),
        SimpleIdServer.IdServer.Config.DefaultScopes.Email,
    ...
    public static List<Client> Clients = new List<Client>
        {
            ...
            ClientBuilder.BuildUserAgentClient("fourteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email, SimpleIdServer.IdServer.Config.DefaultScopes.Address).Build(),
            ClientBuilder.BuildUserAgentClient("fifteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).DisableIdTokenSignature().Build(),
            ClientBuilder.BuildUserAgentClient("sixteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.EcdsaSha256).Build(),
            ClientBuilder.BuildUserAgentClient("seventeenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.EcdsaSha384).Build(),
            ClientBuilder.BuildUserAgentClient("eighteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.EcdsaSha512).Build(),
            ClientBuilder.BuildUserAgentClient("nineteenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.HmacSha256).Build(),
            ClientBuilder.BuildUserAgentClient("twentyClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.HmacSha384).Build(),
            ClientBuilder.BuildUserAgentClient("twentyOneClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.HmacSha512).Build(),
            ClientBuilder.BuildUserAgentClient("twentyTwoClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.RsaSha256).Build(),
            ClientBuilder.BuildUserAgentClient("twentyThreeClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.RsaSha384).Build(),
            ClientBuilder.BuildUserAgentClient("twentyFourClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenSignatureAlg(SecurityAlgorithms.RsaSha512).Build(),
            ClientBuilder.BuildUserAgentClient("twentyFiveClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes128CbcHmacSha256).AddEncryptedKey(ClientEncryptingCredentials["twentyFiveClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentySixClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes192CbcHmacSha384).AddEncryptedKey(ClientEncryptingCredentials["twentySixClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentySevenClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes256CbcHmacSha512).AddEncryptedKey(ClientEncryptingCredentials["twentySevenClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentyEightClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes128CbcHmacSha256).AddEncryptedKey(ClientEncryptingCredentials["twentyEightClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("twentyNineClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes192CbcHmacSha384).AddEncryptedKey(ClientEncryptingCredentials["twentyNineClient"], SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildUserAgentClient("thirtyClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetIdTokenEncryption(SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes256CbcHmacSha512).AddRSAEncryptedKey(new RsaSecurityKey(RSA.Create()) { KeyId = "keyId" }, SecurityAlgorithms.RsaOAEP, SecurityAlgorithms.Aes256CbcHmacSha512, SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyOneClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetRequestObjectSigning(SecurityAlgorithms.RsaSha256).EnableIdTokenInResponseType().AddSigningKey(ClientSigningCredentials["thirtyOneClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).Build(),
            ...
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyThreeClient", "password", null, "http://localhost:8080").AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetRequestObjectSigning(SecurityAlgorithms.RsaSha256).SetRequestObjectEncryption(SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes128CbcHmacSha256).EnableIdTokenInResponseType().AddSigningKey(ClientSigningCredentials["thirtyThreeClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).SetPairwiseSubjectType("salt").Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyFourClient", "password", null, "http://localhost:8080").AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetDefaultMaxAge(2).EnableIdTokenInResponseType().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyFiveClient", "password", null, "http://localhost:8080").AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).EnableIdTokenInResponseType().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtySixClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email, SimpleIdServer.IdServer.Config.DefaultScopes.OfflineAccessScope).EnableOfflineAccess().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtySevenClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyEightClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetUserInfoSignedResponseAlg().Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("thirtyNineClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetUserInfoSignedResponseAlg().SetUserInfoEncryption().AddRSAEncryptedKey(new RsaSecurityKey(RSA.Create()) { KeyId = "keyId" }, SecurityAlgorithms.RsaPKCS1, SecurityAlgorithms.Aes128CbcHmacSha256).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyOneClient", "password", null, "http://localhost:8080").AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Role, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetRequestObjectSigning(SecurityAlgorithms.EcdsaSha384).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyTwoClient", "password", null, "http://localhost:8080").AddScope(SecondScope).AddAuthDataTypes("firstDetails").EnableCIBAGrantType(DefaultNotificationModes.Ping, "http://localhost/notificationedp").UseClientTlsAuthentication("CN=sidClient, O=Internet Widgits Pty Ltd, S=BE, C=BE").AddSigningKey(ClientSigningCredentials["fortyTwoClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).SetMaxRequestParameterLifetimeSeconds(6000).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyThreeClient", "password", null, "http://localhost:8080").AddScope(SecondScope).EnableCIBAGrantType(DefaultNotificationModes.Push, "http://localhost/notificationedp").UseClientTlsAuthentication("CN=sidClient, O=Internet Widgits Pty Ltd, S=BE, C=BE").AddSigningKey(ClientSigningCredentials["fortyThreeClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).SetMaxRequestParameterLifetimeSeconds(6000).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortyFourClient", "password", null, "http://localhost:8080").AddScope(SecondScope).EnableCIBAGrantType(DefaultNotificationModes.Poll).UseClientTlsAuthentication("CN=sidClient, O=Internet Widgits Pty Ltd, S=BE, C=BE").AddSigningKey(ClientSigningCredentials["fortyFourClient"], SecurityAlgorithms.RsaSha256, SecurityKeyTypes.RSA).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortySixClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().EnableTokenInResponseType().EnableRefreshTokenGrantType().ResourceParameterIsRequired().AddScope(AdminScope, CalendarScope, SimpleIdServer.IdServer.Config.DefaultScopes.OfflineAccessScope).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fortySevenClient", "password", null, "http://localhost:8080").AddAuthDataTypes("secondDetails").UseClientSecretPostAuthentication().EnableTokenInResponseType().EnableRefreshTokenGrantType().AddScope(AdminScope, CalendarScope, SimpleIdServer.IdServer.Config.DefaultScopes.OfflineAccessScope).EnableAccessToGrantsApi().DisableConsent().Build(),
            ...
            ClientBuilder.BuildTraditionalWebsiteClient("fortyNineClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(AdminScope, CalendarScope).AddAuthDataTypes("secondDetails").EnableCIBAGrantType(DefaultNotificationModes.Poll, interval: 0).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fiftyClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(AdminScope, CalendarScope).EnableCIBAGrantType(DefaultNotificationModes.Poll).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fiftyOneClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(AdminScope, CalendarScope).EnableCIBAGrantType(DefaultNotificationModes.Push, "http://localhost/notificationedp").Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fiftyTwoClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().AddScope(AdminScope, CalendarScope).EnableCIBAGrantType(DefaultNotificationModes.Ping, "http://localhost/notificationedp", 0).Build(),
            ClientBuilder.BuildApiClient("fiftyThreeClient", "password").EnableUMAGrantType().ActAsUMAResourceServer().Build(),
            ClientBuilder.BuildUserAgentClient("fiftyFourClient", "password", null, "http://localhost:8080").UseImplicitFlow().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.OpenIdScope, SimpleIdServer.IdServer.Config.DefaultScopes.Profile, SimpleIdServer.IdServer.Config.DefaultScopes.Email).SetSigAuthorizationResponse(SecurityAlgorithms.RsaSha256).Build(),
            ...
            FiftySixClient,
            ClientBuilder.BuildApiClient("fiftySevenClient", "password").AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.Users).AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.Register).Build(),
            ClientBuilder.BuildTraditionalWebsiteClient("fiftyEightClient", "password", null, "http://localhost:8080").UseClientSecretPostAuthentication().EnableTokenInResponseType().AddAuthDataTypes("openid_credential").DisableConsent().AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.GrantManagementQuery, SimpleIdServer.IdServer.Config.DefaultScopes.GrantManagementRevoke).Build(),
            ...
            ClientBuilder.BuildApiClient("sixtyTwoClient", "password").AddScope(SimpleIdServer.IdServer.Config.DefaultScopes.Acrs).Build(),
