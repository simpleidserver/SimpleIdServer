...
Scenario: Get the configuration
	...
	And JSON '$.grant_types_supported[5]'='urn:ietf:params:oauth:grant-type:pre-authorized_code'
	And JSON '$.grant_types_supported[6]'='authorization_code'
	And JSON '$.grant_types_supported[7]'='implicit'
