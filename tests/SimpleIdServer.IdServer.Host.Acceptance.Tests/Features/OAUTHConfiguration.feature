...
Scenario: Get the configuration
	...
	And JSON '$.grant_types_supported[6]'='urn:ietf:params:oauth:grant-type:device_code'
	And JSON '$.grant_types_supported[7]'='urn:ietf:params:oauth:grant-type:pre-authorized_code'
	And JSON '$.grant_types_supported[8]'='authorization_code'
	And JSON '$.grant_types_supported[9]'='implicit'
