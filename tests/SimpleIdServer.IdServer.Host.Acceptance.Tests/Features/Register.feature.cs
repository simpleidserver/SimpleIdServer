...
#line hidden
            ...
            else
            {
                ...
                table176.AddRow(new string[] {
                            ...
                            "newClient"});
#line 5
 testRunner.When("execute HTTP POST request \'https://localhost:8080/register\'", ((string)(null)), table176, "When ");
#line hidden
#line 9
...
#line hidden
            ...
            else
            {
                ...
                table177.AddRow(new string[] {
                            ...
                            "newClient2"});
#line 14
 testRunner.When("execute HTTP POST request \'https://localhost:8080/register\'", ((string)(null)), table177, "When ");
#line hidden
#line 18
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table178.AddRow(new string[] {
                            ...
                            "Bearer $accessToken$"});
#line 21
 testRunner.And("execute HTTP GET request \'https://localhost:8080/register/newClient2\'", ((string)(null)), table178, "And ");
#line hidden
#line 25
...
#line hidden
            ...
            else
            {
                ...
                table179.AddRow(new string[] {
                            ...
                            "newClient3"});
#line 28
 testRunner.When("execute HTTP POST request \'https://localhost:8080/register\'", ((string)(null)), table179, "When ");
#line hidden
#line 32
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table180.AddRow(new string[] {
                            ...
                            "client_secret_basic"});
#line 35
 testRunner.And("execute HTTP PUT request \'https://localhost:8080/register/newClient3\'", ((string)(null)), table180, "And ");
#line hidden
#line 41
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
