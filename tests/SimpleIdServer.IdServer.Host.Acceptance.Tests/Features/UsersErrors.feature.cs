...
#line hidden
            ...
            else
            {
                ...
                TechTalk.SpecFlow.Table table484 = new TechTalk.SpecFlow.Table(new string[] {
                            ...
                            "Value"});
#line 23
 testRunner.When("execute HTTP DELETE request \'https://localhost:8080/users/id\'", ((string)(null)), table484, "When ");
#line hidden
#line 26
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table487.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 51
 testRunner.When("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table487, "When ");
#line hidden
#line 55
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table489.AddRow(new string[] {
                            ...
                            "user"});
#line 71
 testRunner.When("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table489, "When ");
#line hidden
#line 76
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table491.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 92
 testRunner.When("execute HTTP GET request \'https://localhost:8080/users/id\'", ((string)(null)), table491, "When ");
#line hidden
#line 96
...
#line hidden
                ...
                table493.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 109
 testRunner.When("execute HTTP DELETE request \'https://localhost:8080/users/id\'", ((string)(null)), table493, "When ");
#line hidden
#line 113
 testRunner.Then("HTTP status code equals to \'404\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table499.AddRow(new string[] {
                            ...
                            "value"});
#line 167
 testRunner.When("execute HTTP PUT JSON request \'https://localhost:8080/users/id/credentials\'", ((string)(null)), table499, "When ");
#line hidden
#line 173
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table501.AddRow(new string[] {
                            ...
                            "value"});
#line 189
 testRunner.When("execute HTTP PUT JSON request \'https://localhost:8080/users/id/credentials\'", ((string)(null)), table501, "When ");
#line hidden
#line 195
 testRunner.Then("HTTP status code equals to \'404\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
