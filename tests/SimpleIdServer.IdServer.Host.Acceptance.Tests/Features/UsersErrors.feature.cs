...
#line hidden
            ...
            else
            {
                ...
                TechTalk.SpecFlow.Table table587 = new TechTalk.SpecFlow.Table(new string[] {
                            ...
                            "Value"});
#line 5
 testRunner.When("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table587, "When ");
#line hidden
#line 8
...
#line hidden
            ...
            else
            {
                ...
                TechTalk.SpecFlow.Table table588 = new TechTalk.SpecFlow.Table(new string[] {
                            ...
                            "Value"});
#line 14
 testRunner.When("execute HTTP GET request \'https://localhost:8080/users/id\'", ((string)(null)), table588, "When ");
#line hidden
#line 17
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                TechTalk.SpecFlow.Table table589 = new TechTalk.SpecFlow.Table(new string[] {
                            ...
                            "Value"});
#line 23
 testRunner.When("execute HTTP DELETE request \'https://localhost:8080/users/id\'", ((string)(null)), table589, "When ");
#line hidden
#line 26
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table592.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 51
 testRunner.When("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table592, "When ");
#line hidden
#line 55
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table596.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 92
 testRunner.When("execute HTTP GET request \'https://localhost:8080/users/id\'", ((string)(null)), table596, "When ");
#line hidden
#line 96
...
#line hidden
                ...
                table598.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 109
 testRunner.When("execute HTTP DELETE request \'https://localhost:8080/users/id\'", ((string)(null)), table598, "When ");
#line hidden
#line 113
 testRunner.Then("HTTP status code equals to \'404\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table600.AddRow(new string[] {
                            ...
                            "value"});
#line 126
 testRunner.When("execute HTTP PUT JSON request \'https://localhost:8080/users/id/credentials/cred\'", ((string)(null)), table600, "When ");
#line hidden
#line 132
 testRunner.Then("HTTP status code equals to \'404\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
