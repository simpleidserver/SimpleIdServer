...
#line hidden
                ...
                table579.AddRow(new string[] {
                            ...
                            "newUser"});
#line 15
 testRunner.And("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table579, "And ");
#line hidden
#line 20
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table585.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 70
 testRunner.When("execute HTTP DELETE request \'https://localhost:8080/users/$id$\'", ((string)(null)), table585, "When ");
#line hidden
#line 74
