...
#line hidden
                ...
                table599.AddRow(new string[] {
                            ...
                            "newUser"});
#line 15
 testRunner.And("execute HTTP POST JSON request \'http://localhost/users\'", ((string)(null)), table599, "And ");
#line hidden
#line 20
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table601.AddRow(new string[] {
                            ...
                            "newuser2"});
#line 36
 testRunner.When("execute HTTP POST JSON request \'http://localhost/users\'", ((string)(null)), table601, "When ");
#line hidden
#line 41
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table602.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 44
 testRunner.When("execute HTTP GET request \'http://localhost/users/$id$\'", ((string)(null)), table602, "When ");
#line hidden
#line 48
...
#line hidden
                ...
                table604.AddRow(new string[] {
                            ...
                            "newuser3"});
#line 62
 testRunner.When("execute HTTP POST JSON request \'http://localhost/users\'", ((string)(null)), table604, "When ");
#line hidden
#line 67
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table605.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 70
 testRunner.When("execute HTTP DELETE request \'http://localhost/users/$id$\'", ((string)(null)), table605, "When ");
#line hidden
#line 74
