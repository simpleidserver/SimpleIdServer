...
#line hidden
                ...
                table570.AddRow(new string[] {
                            ...
                            "newUser"});
#line 15
 testRunner.And("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table570, "And ");
#line hidden
#line 20
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table572.AddRow(new string[] {
                            ...
                            "newuser2"});
#line 36
 testRunner.When("execute HTTP POST JSON request \'https://localhost:8080/users\'", ((string)(null)), table572, "When ");
#line hidden
#line 41
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table573.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 44
 testRunner.When("execute HTTP GET request \'https://localhost:8080/users/$id$\'", ((string)(null)), table573, "When ");
#line hidden
#line 48
...
#line hidden
                ...
                table576.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 70
 testRunner.When("execute HTTP DELETE request \'https://localhost:8080/users/$id$\'", ((string)(null)), table576, "When ");
#line hidden
#line 74
