...
#line hidden
            ...
            else
            {
                ...
                TechTalk.SpecFlow.Table table74 = new TechTalk.SpecFlow.Table(new string[] {
                            ...
                            "Value"});
#line 5
 testRunner.When("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table74, "When ");
#line hidden
#line 8
...
#line 14
 testRunner.Given("build JWS by signing with a random RS256 algorithm and store the result into \'acc" +
                        "essToken\'", ((string)(null)), table75, "Given ");
#line hidden
                ...
                table76.AddRow(new string[] {
                            ...
                            "Bearer $accessToken$"});
#line 18
 testRunner.When("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table76, "When ");
#line hidden
#line 22
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table77.AddRow(new string[] {
                            ...
                            "user"});
#line 28
 testRunner.Given("build access_token and sign with the key \'keyid\'", ((string)(null)), table77, "Given ");
#line hidden
