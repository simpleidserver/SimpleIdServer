...
#line 14
 testRunner.Given("build JWS by signing with a random RS256 algorithm and store the result into \'acc" +
                        "essToken\'", ((string)(null)), table80, "Given ");
#line hidden
                ...
                table81.AddRow(new string[] {
                            ...
                            "Bearer $accessToken$"});
#line 18
 testRunner.When("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table81, "When ");
#line hidden
#line 22
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table82.AddRow(new string[] {
                            ...
                            "user"});
#line 28
 testRunner.Given("build access_token and sign with the key \'keyid\'", ((string)(null)), table82, "Given ");
#line hidden
                ...
                table83.AddRow(new string[] {
                            ...
                            "invalid"});
#line 32
 testRunner.When("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table83, "When ");
#line hidden
#line 37
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
