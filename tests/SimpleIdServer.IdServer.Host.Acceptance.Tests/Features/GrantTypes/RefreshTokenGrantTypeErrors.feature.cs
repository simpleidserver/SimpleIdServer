...
#line hidden
                ...
                table375.AddRow(new string[] {
                            ...
                            "password"});
#line 99
 testRunner.And("execute HTTP POST request \'https://localhost:8080/token\'", ((string)(null)), table375, "And ");
#line hidden
#line 106
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 112
 testRunner.When("build DPoP proof", ((string)(null)), table376, "When ");
#line hidden
                ...
                table377.AddRow(new string[] {
                            ...
                            "https://localhost:8080/token"});
#line 117
 testRunner.And("build DPoP proof and store into \'DPOP2\'", ((string)(null)), table377, "And ");
#line hidden
                ...
                table378.AddRow(new string[] {
                            ...
                            "$DPOP$"});
#line 122
 testRunner.And("execute HTTP POST request \'https://localhost:8080/token\'", ((string)(null)), table378, "And ");
#line hidden
#line 130
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
