...
#line 112
 testRunner.When("build DPoP proof", ((string)(null)), table378, "When ");
#line hidden
                ...
                table379.AddRow(new string[] {
                            ...
                            "https://localhost:8080/token"});
#line 117
 testRunner.And("build DPoP proof and store into \'DPOP2\'", ((string)(null)), table379, "And ");
#line hidden
...
#line hidden
                ...
                table381.AddRow(new string[] {
                            ...
                            "$DPOP2$"});
#line 133
 testRunner.And("execute HTTP POST request \'https://localhost:8080/token\'", ((string)(null)), table381, "And ");
#line hidden
#line 141
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
