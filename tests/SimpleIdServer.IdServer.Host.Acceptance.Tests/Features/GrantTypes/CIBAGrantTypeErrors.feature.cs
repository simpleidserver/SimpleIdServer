...
#line hidden
            ...
            else
            {
                ...
                table223.AddRow(new string[] {
                            ...
                            "sidClient.crt"});
#line 5
 testRunner.When("execute HTTP POST request \'https://localhost:8080/mtls/token\'", ((string)(null)), table223, "When ");
#line hidden
#line 11
...
#line hidden
            ...
            else
            {
                ...
                table224.AddRow(new string[] {
                            ...
                            "sidClient.crt"});
#line 17
 testRunner.When("execute HTTP POST request \'https://localhost:8080/mtls/token\'", ((string)(null)), table224, "When ");
#line hidden
#line 23
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table225.AddRow(new string[] {
                            ...
                            "id"});
#line 29
 testRunner.When("execute HTTP POST request \'https://localhost:8080/mtls/token\'", ((string)(null)), table225, "When ");
#line hidden
#line 36
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table232.AddRow(new string[] {
                            ...
                            "user"});
#line 111
 testRunner.And("build access_token and sign with the key \'keyid\'", ((string)(null)), table232, "And ");
#line hidden
                ...
                table233.AddRow(new string[] {
                            ...
                            "password"});
#line 115
 testRunner.When("execute HTTP POST request \'https://localhost:8080/bc-authorize\'", ((string)(null)), table233, "When ");
#line hidden
#line 123
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table234.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 126
 testRunner.And("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table234, "And ");
#line hidden
