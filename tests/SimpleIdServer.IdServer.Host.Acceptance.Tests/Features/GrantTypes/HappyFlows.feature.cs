...
#line hidden
                ...
                table201.AddRow(new string[] {
                            ...
                            "secondScope"});
#line 48
 testRunner.When("execute HTTP GET request \'https://localhost:8080/authorization\'", ((string)(null)), table201, "When ");
#line hidden
#line 57
...
#line hidden
                ...
                table203.AddRow(new string[] {
                            ...
                            "secondScope"});
#line 78
 testRunner.When("execute HTTP POST request \'https://localhost:8080/par\'", ((string)(null)), table203, "When ");
#line hidden
#line 87
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table204.AddRow(new string[] {
                            ...
                            "$request_uri$"});
#line 90
 testRunner.And("execute HTTP GET request \'https://localhost:8080/authorization\'", ((string)(null)), table204, "And ");
#line hidden
#line 95
 testRunner.And("extract parameter \'code\' from redirect url", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table206.AddRow(new string[] {
                            ...
                            "{ \"type\" : \"secondDetails\", \"locations\": [ \"https://cal.example.com\" ], \"actions\"" +
                                ": [ \"read\" ] }"});
#line 116
 testRunner.When("execute HTTP POST request \'https://localhost:8080/par\'", ((string)(null)), table206, "When ");
#line hidden
#line 126
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table207.AddRow(new string[] {
                            ...
                            "$request_uri$"});
#line 129
 testRunner.And("execute HTTP GET request \'https://localhost:8080/authorization\'", ((string)(null)), table207, "And ");
#line hidden
#line 134
 testRunner.And("extract parameter \'code\' from redirect url", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 234
 testRunner.And("execute HTTP POST request \'https://localhost:8080/bc-authorize\'", ((string)(null)), table216, "And ");
#line hidden
#line 243
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table217.AddRow(new string[] {
                            ...
                            "0"});
#line 246
 testRunner.And("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table217, "And ");
#line hidden
#line 252
...
#line hidden
                ...
                table219.AddRow(new string[] {
                            ...
                            "04bcf708-dfba-4719-a3d3-b213322e2c38"});
#line 271
 testRunner.And("execute HTTP POST request \'https://localhost:8080/bc-authorize\'", ((string)(null)), table219, "And ");
#line hidden
#line 280
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table220.AddRow(new string[] {
                            ...
                            "0"});
#line 283
 testRunner.And("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table220, "And ");
#line hidden
#line 289
 testRunner.And("polls until notification is received", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table222.AddRow(new string[] {
                            ...
                            "user@hotmail.fr"});
#line 304
 testRunner.Given("build JWS id_token_hint and sign with the key \'keyid\'", ((string)(null)), table222, "Given ");
#line hidden
                ...
                table223.AddRow(new string[] {
                            ...
                            "client_credentials"});
#line 309
 testRunner.When("execute HTTP POST request \'http://localhost/token\'", ((string)(null)), table223, "When ");
#line hidden
#line 316
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table224.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 319
 testRunner.And("execute HTTP POST JSON request \'http://localhost/rreguri\'", ((string)(null)), table224, "And ");
#line hidden
#line 331
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table225.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 334
 testRunner.And("execute HTTP PUT JSON request \'http://localhost/rreguri/$_id$/permissions\'", ((string)(null)), table225, "And ");
#line hidden
                ...
                table226.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 339
 testRunner.And("execute HTTP POST JSON request \'http://localhost/perm\'", ((string)(null)), table226, "And ");
#line hidden
#line 345
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table227.AddRow(new string[] {
                            ...
                            "scope1 scope2"});
#line 348
 testRunner.And("execute HTTP POST request \'http://localhost/token\'", ((string)(null)), table227, "And ");
#line hidden
#line 358
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
