...
#line hidden
                ...
                table196.AddRow(new string[] {
                            ...
                            "secondScope"});
#line 78
 testRunner.When("execute HTTP POST request \'https://localhost:8080/par\'", ((string)(null)), table196, "When ");
#line hidden
#line 87
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table197.AddRow(new string[] {
                            ...
                            "$request_uri$"});
#line 90
 testRunner.And("execute HTTP GET request \'https://localhost:8080/authorization\'", ((string)(null)), table197, "And ");
#line hidden
#line 95
 testRunner.And("extract parameter \'code\' from redirect url", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table199.AddRow(new string[] {
                            ...
                            "{ \"type\" : \"secondDetails\", \"locations\": [ \"https://cal.example.com\" ], \"actions\"" +
                                ": [ \"read\" ] }"});
#line 116
 testRunner.When("execute HTTP POST request \'https://localhost:8080/par\'", ((string)(null)), table199, "When ");
#line hidden
#line 126
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table200.AddRow(new string[] {
                            ...
                            "$request_uri$"});
#line 129
 testRunner.And("execute HTTP GET request \'https://localhost:8080/authorization\'", ((string)(null)), table200, "And ");
#line hidden
#line 134
 testRunner.And("extract parameter \'code\' from redirect url", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table210.AddRow(new string[] {
                            ...
                            "0"});
#line 246
 testRunner.And("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table210, "And ");
#line hidden
#line 252
...
#line hidden
            ...
            else
            {
                ...
                table215.AddRow(new string[] {
                            ...
                            "user@hotmail.fr"});
#line 304
 testRunner.Given("build JWS id_token_hint and sign with the key \'keyid\'", ((string)(null)), table215, "Given ");
#line hidden
                ...
                table216.AddRow(new string[] {
                            ...
                            "client_credentials"});
#line 309
 testRunner.When("execute HTTP POST request \'http://localhost/token\'", ((string)(null)), table216, "When ");
#line hidden
#line 316
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table217.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 319
 testRunner.And("execute HTTP POST JSON request \'http://localhost/rreguri\'", ((string)(null)), table217, "And ");
#line hidden
#line 331
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table218.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 334
 testRunner.And("execute HTTP PUT JSON request \'http://localhost/rreguri/$_id$/permissions\'", ((string)(null)), table218, "And ");
#line hidden
                ...
                table219.AddRow(new string[] {
                            ...
                            "Bearer $access_token$"});
#line 339
 testRunner.And("execute HTTP POST JSON request \'http://localhost/perm\'", ((string)(null)), table219, "And ");
#line hidden
#line 345
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table220.AddRow(new string[] {
                            ...
                            "scope1 scope2"});
#line 348
 testRunner.And("execute HTTP POST request \'http://localhost/token\'", ((string)(null)), table220, "And ");
#line hidden
#line 358
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table222.AddRow(new string[] {
                            ...
                            "{ \"type\" : \"secondDetails\", \"locations\": [ \"https://cal.example.com\" ], \"actions\"" +
                                ": [ \"read\" ] }"});
#line 383
 testRunner.And("execute HTTP POST request \'https://localhost:8080/bc-authorize\'", ((string)(null)), table222, "And ");
#line hidden
#line 391
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table223.AddRow(new string[] {
                            ...
                            "0"});
#line 394
 testRunner.And("execute HTTP POST JSON request \'http://localhost/bc-callback\'", ((string)(null)), table223, "And ");
#line hidden
