...
#line hidden
                ...
                table311.AddRow(new string[] {
                            ...
                            "credTemplate"});
#line 74
 testRunner.When("execute HTTP POST JSON request \'http://localhost/credential_offer/share\'", ((string)(null)), table311, "When ");
#line hidden
#line 79
...
#line hidden
                ...
                table313.AddRow(new string[] {
                            ...
                            "credTemplate"});
#line 98
 testRunner.When("execute HTTP POST JSON request \'http://localhost/credential_offer/share\'", ((string)(null)), table313, "When ");
#line hidden
#line 103
 testRunner.And("extract query parameters into JSON", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
