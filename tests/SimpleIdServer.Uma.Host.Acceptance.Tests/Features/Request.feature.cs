...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Confirm pending request")]
        [Xunit.TraitAttribute("FeatureTitle", "Request")]
        [Xunit.TraitAttribute("Description", "Confirm pending request")]
        public virtual void ConfirmPendingRequest()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Confirm pending request", null, ((string[])(null)));
#line 105
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
#line hidden
...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Delete pending request")]
        [Xunit.TraitAttribute("FeatureTitle", "Request")]
        [Xunit.TraitAttribute("Description", "Delete pending request")]
        public virtual void DeletePendingRequest()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Delete pending request", null, ((string[])(null)));
#line 190
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
#line hidden
