...
#line hidden
                ...
                table328.AddRow(new string[] {
                            ...
                            "ES256"});
#line 80
 testRunner.And("add JSON web key to Authorization Server and store into \'jwks\'", ((string)(null)), table328, "And ");
#line hidden
                ...
                table329.AddRow(new string[] {
                            ...
                            "[openid,profile]"});
#line 84
 testRunner.And("use \'1\' JWK from \'jwks\' to build JWS and store into \'accesstoken\'", ((string)(null)), table329, "And ");
#line hidden
#line 90
 testRunner.And("add user consent : user=\'administrator\', scope=\'profile\', clientId=\'$client_id$\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table330.AddRow(new string[] {
                            ...
                            "Bearer $accesstoken$"});
#line 92
 testRunner.And("execute HTTP GET request \'http://localhost/userinfo\'", ((string)(null)), table330, "And ");
#line hidden
#line 96
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
