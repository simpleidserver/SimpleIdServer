Feature: BCDeviceRegistrationErrors
	Check errors returned by /bc-device-registration endpoint

Scenario: Error is returned when 'id_token_hint' is missing
...
Scenario: Error is returned when 'device_registration_token' is missing
	...
	Then HTTP status code equals to '400'
	Then JSON 'error'='invalid_request'
	Then JSON 'error_description'='missing parameter device_registration_token'