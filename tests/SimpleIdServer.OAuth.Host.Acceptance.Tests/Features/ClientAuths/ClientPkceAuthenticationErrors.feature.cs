...
#line hidden
        ...
        public ClientPkceAuthenticationErrorsFeature(ClientPkceAuthenticationErrorsFeature.FixtureData fixtureData, SimpleIdServer_OAuth_Host_Acceptance_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
            ...
            else
            {
                ...
                table8.AddRow(new string[] {
                            ...
                            "nineClient"});
#line 5
 testRunner.When("execute HTTP POST request \'https://localhost:8080/token\'", ((string)(null)), table8, "When ");
#line hidden
#line 11
...
#line hidden
            ...
            else
            {
                ...
                table10.AddRow(new string[] {
                            ...
                            "code"});
#line 30
 testRunner.When("execute HTTP POST request \'https://localhost:8080/token\'", ((string)(null)), table10, "When ");
#line hidden
#line 38
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table11.AddRow(new string[] {
                            ...
                            "challenge"});
#line 45
 testRunner.When("execute HTTP GET request \'https://localhost:8080/authorization\'", ((string)(null)), table11, "When ");
#line hidden
#line 56
...
#line hidden
                ...
                table12.AddRow(new string[] {
                            ...
                            "$code$"});
#line 58
 testRunner.And("execute HTTP POST request \'https://localhost:8080/token\'", ((string)(null)), table12, "And ");
#line hidden
#line 66
 testRunner.And("extract JSON from body", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
