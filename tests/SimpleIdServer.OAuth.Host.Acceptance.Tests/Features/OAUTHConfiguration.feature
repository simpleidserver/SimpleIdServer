...
Scenario: Get the configuration
	...
	And JSON '$.response_types_supported[1]'='code token'
	...
	And JSON '$.grant_types_supported[3]'='implicit'
	...
	And JSON '$.token_endpoint_auth_signing_alg_values_supported[6]'='RS256'
	And JSON '$.token_endpoint_auth_signing_alg_values_supported[7]'='RS384'
	And JSON '$.token_endpoint_auth_signing_alg_values_supported[8]'='RS512'
	And JSON '$.token_endpoint_auth_signing_alg_values_supported[9]'='PS256'
	And JSON '$.token_endpoint_auth_signing_alg_values_supported[10]'='PS384'
	And JSON '$.token_endpoint_auth_signing_alg_values_supported[11]'='PS512'
