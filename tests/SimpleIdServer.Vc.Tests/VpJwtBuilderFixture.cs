...
{
    public class VpJwtBuilderFixture
    {
        [Test]
        public void When_Build_VpJWT_Then_SignatureIsCorrect()
        {
            ...
            var verifiablePresentation = VerifiablePresentationBuilder
                .New()
                .AddVerifiableCredential(verifiableCredential)
                .Build();
            var jwt = VpJwtBuilder.GenerateToken(identityDocument, verifiablePresentation, hex.HexToByteArray(), "did#delegate-1");
