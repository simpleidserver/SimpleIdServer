...
namespace SimpleIdServer.IdServer.Website.Infrastructures
{
    public class CustomRequestLocalizationMiddleware
    {
        ...
        private readonly ILogger<CustomRequestLocalizationMiddleware> _logger;
        ...
        public CustomRequestLocalizationMiddleware(RequestDelegate next, IOptions<RequestLocalizationOptions> options, ILogger<CustomRequestLocalizationMiddleware> logger)
        {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            _logger.LogError("INVOKE CustomRequestLocalizationMiddleware");
            if (_options.RequestCultureProviders != null)
            {
                foreach (var provider in _options.RequestCultureProviders)
                {
                    ...
                    _logger.LogError($"CULTURE CustomRequestLocalizationMiddleware {(providerResultCulture == null ? string.Empty : JsonSerializer.Serialize(providerResultCulture))}");
