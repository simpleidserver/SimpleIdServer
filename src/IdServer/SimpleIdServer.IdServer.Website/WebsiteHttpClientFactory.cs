    ...
    public class WebsiteHttpClientFactory : IWebsiteHttpClientFactory
    {
        ...
        private async Task<GetAccessTokenResult> GetAccessToken()
        {
            ...
            var content = new List<KeyValuePair<string, string>>
            {
                ...
                new KeyValuePair<string, string>("scope", "provisioning networks users credential_offer acrs configurations authenticationschemeproviders authenticationmethods registrationworkflows apiresources auditing certificateauthorities clients credential_templates users"),
