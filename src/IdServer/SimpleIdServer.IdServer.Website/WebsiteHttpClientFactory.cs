    ...
    public class WebsiteHttpClientFactory : IWebsiteHttpClientFactory
    {
        ...
        private async Task<GetAccessTokenResult> GetAccessToken(string currentRealm = null)
        {
            ...
            var content = new List<KeyValuePair<string, string>>
            {
                ...
                new KeyValuePair<string, string>("scope", "provisioning users acrs configurations authenticationschemeproviders authenticationmethods registrationworkflows apiresources auditing certificateauthorities clients realms groups scopes federation_entities workflows forms"),
