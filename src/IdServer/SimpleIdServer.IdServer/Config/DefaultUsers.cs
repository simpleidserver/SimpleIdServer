...
public static class DefaultUsers
{
    ...
    public static User Administrator = UserBuilder.Create("administrator", "password", "Administrator").SetFirstname("Administrator").EnableTemporaryPassword().SetEmail("adm@email.com").SetPhoneNumber("0485").SetPicture("https://cdn-icons-png.flaticon.com/512/149/149071.png").AddGroup(DefaultGroups.AdministratorGroup).GenerateRandomTOTPKey().Build();
