...
namespace SimpleIdServer.IdServer.Api.Authorization
{
    public class RedirectActionAuthorizationResponse : AuthorizationResponse
    {
        ...
        public RedirectActionAuthorizationResponse(string action, string controllerName, JsonObject queryParameters, string area, bool disconnect = false, List<string> cookiesToRemove = null) : this(action, controllerName, queryParameters)
        {
            Area = area;
