...
namespace SimpleIdServer.IdServer.Api.PushedAuthorization
{
    public class PushedAuthorizationController : Controller
    {
        ...
        public PushedAuthorizationController(IAuthorizationRequestValidator validator, IAuthenticateClient authenticateClient, IBusControl busControl, IDistributedCache distributedCache, IEnumerable<IOAuthClientAuthenticationHandler> authenticationHandlers, IOptions<IdServerHostOptions> options)
        {
