...
{
    private static List<string> claimsToInclude = new List<string>
    {
        DefaultUserClaims.Picture
    };
    ...
    public virtual ICollection<Claim> Transform(User user)
    {
        ...
        foreach (var cl in user.Claims.Where(cl => claimsToInclude.Contains(cl.Type)))
        {
            result.Add(cl);
        }
