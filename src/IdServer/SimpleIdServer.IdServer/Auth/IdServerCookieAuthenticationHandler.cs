...
{
    public class IdServerCookieAuthenticationHandler : SignInAuthenticationHandler<CookieAuthenticationOptions>
    {
        private static class AuthenticateResults
        {
            public static AuthenticateResult FailedUnprotectingTicket = AuthenticateResult.Fail("Unprotect ticket failed");
            public static AuthenticateResult MissingSessionId = AuthenticateResult.Fail("SessionId missing");
            public static AuthenticateResult MissingIdentityInSession = AuthenticateResult.Fail("Identity missing in session store");
            public static AuthenticateResult ExpiredTicket = AuthenticateResult.Fail("Ticket expired");
            public static AuthenticateResult NoPrincipal = AuthenticateResult.Fail("No principal.");
        }
