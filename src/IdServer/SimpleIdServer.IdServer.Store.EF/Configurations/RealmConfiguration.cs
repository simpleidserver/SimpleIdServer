...
namespace SimpleIdServer.IdServer.Store.Configurations
{
    public class RealmConfiguration : IEntityTypeConfiguration<Realm>
    {
        public void Configure(EntityTypeBuilder<Realm> builder)
        {
            ...
            builder.HasMany(u => u.PresentationDefinitions).WithOne(u => u.Realm).HasForeignKey(u => u.RealmName);
            builder.HasMany(u => u.Roles).WithOne(u => u.Realm).HasForeignKey(u => u.RealmName);
        }
    }
}
