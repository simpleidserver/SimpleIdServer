...
namespace SimpleIdServer.Did.Services
{
    ...
    {
        public DIDDeployment() : base(BYTECODE) { }
        public DIDDeployment(string byteCode) : base(byteCode) { }
    }

    public class DIDDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public DIDDeploymentBase() : base(BYTECODE) { }
        public DIDDeploymentBase(string byteCode) : base(byteCode) { }
