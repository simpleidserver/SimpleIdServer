...
public class IdServerConfiguration
{
    ...
    public static ICollection<RegistrationWorkflow> RegistrationWorkflows => new List<RegistrationWorkflow>
    {
        ...
        RegistrationWorkflowBuilder.New("complex", DataSeeder.BuildComplexRegistrationWorkflow().Id).Build()
    };
    ...
    public static ICollection<Scope> Scopes => new List<Scope>
    {
        ...
        SimpleIdServer.IdServer.Constants.StandardScopes.RecurringJobs
    };
    ...
    public static ICollection<Client> Clients => new List<Client>
    {
        ...
        ClientBuilder.BuildApiClient("scimClient", "password").AddScope(ScimScope)
            .Build(),
        ClientBuilder.BuildApiClient("fastFed", "password").AddScope(SimpleIdServer.IdServer.Constants.StandardScopes.Clients, SimpleIdServer.IdServer.Constants.StandardScopes.Scopes).Build(),
