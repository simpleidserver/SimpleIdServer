...
public static class StandardFidoAuthForms
{
    ...
    public static FormRecord MobileForm = QrCodeFormLayoutBuilder.New("mobileAuth", Constants.MobileAMR, LayoutTranslations.Login)
        .ConfigureQrCodeGenerationForm(mobileFormId)
        .ConfigureDisplayQrCode()
        .Build();

    public static FormRecord WebauthnForm = AuthLayoutBuilder.New("webauthnAuth", Constants.AMR)
