...
{
    public class InitMobileConfigurationDefDataseeder : BaseConfigurationDefinitionDataseeder<MobileOptions>
    {
        public InitMobileConfigurationDefDataseeder(
        ...
        public override string Name => nameof(InitMobileConfigurationDefDataseeder);
    }
}
