...
{
    public partial class DIDService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, DIDDeployment ethereumDIDDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<DIDDeployment>().SendRequestAndWaitForReceiptAsync(ethereumDIDDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, DIDDeployment ethereumDIDDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<DIDDeployment>().SendRequestAsync(ethereumDIDDeployment);
        }

        public static async Task<DIDService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, DIDDeployment ethereumDIDDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, ethereumDIDDeployment, cancellationTokenSource);
            return new DIDService(web3, receipt.ContractAddress);
        }
        ...
        public DIDService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public DIDService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
