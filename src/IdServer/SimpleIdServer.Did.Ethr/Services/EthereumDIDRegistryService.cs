...
{
    public partial class EthereumDIDRegistryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, EthereumDIDRegistryDeployment ethereumDIDRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, EthereumDIDRegistryDeployment ethereumDIDRegistryDeployment)
        {
        ...
        public static async Task<EthereumDIDRegistryService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, EthereumDIDRegistryDeployment ethereumDIDRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public EthereumDIDRegistryService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public EthereumDIDRegistryService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
