...
namespace SimpleIdServer.OAuth.Api.Token.Validators
{
    ...
    public class AuthorizationCodeGrantTypeValidator : IAuthorizationCodeGrantTypeValidator
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(context.Request.Data.GetStr(TokenRequestParameters.Code)))
            {
            ...
            if (string.IsNullOrWhiteSpace(context.Request.Data.GetStr(TokenRequestParameters.RedirectUri)))
            {
