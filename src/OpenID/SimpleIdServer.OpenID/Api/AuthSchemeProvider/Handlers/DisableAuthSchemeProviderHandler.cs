...
{
    public interface IDisableAuthSchemeProviderHandler
    {
        Task Handle(string id, CancellationToken cancellationToken);
    }

    public class DisableAuthSchemeProviderHandler : IDisableAuthSchemeProviderHandler
    {
        ...
        public DisableAuthSchemeProviderHandler(
