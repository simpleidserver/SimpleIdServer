        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NbReferences = table.Column<int>(type: "integer", nullable: false),
                    TargetReferenceId = table.Column<string>(type: "text", nullable: true),
                    TargetAttributeId = table.Column<string>(type: "text", nullable: true),
                    SCIMRepresentationId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SCIMRepresentationIndirectReference", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SCIMRepresentationIndirectReference_SCIMRepresentationLst_S~",
