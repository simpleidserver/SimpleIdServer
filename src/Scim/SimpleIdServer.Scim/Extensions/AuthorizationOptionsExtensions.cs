...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class AuthorizationOptionsExtensions
    {
        public static void AddDefaultSCIMAuthorizationPolicy(this AuthorizationOptions opts)
        {
            ...
            */
            opts.AddPolicy("QueryScimResource", p => p.RequireAssertion(s => true));
            opts.AddPolicy("AddScimResource", p => p.RequireAssertion(s => true));
            opts.AddPolicy("DeleteScimResource", p => p.RequireAssertion(s => true));
            opts.AddPolicy("UpdateScimResource", p => p.RequireAssertion(s => true));
            opts.AddPolicy("BulkScimResource", p => p.RequireAssertion(s => true));
            opts.AddPolicy("UserAuthenticated", p => p.RequireAssertion(s => true));
        }
    }
}