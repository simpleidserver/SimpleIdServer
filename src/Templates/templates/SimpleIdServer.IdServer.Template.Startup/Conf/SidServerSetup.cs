...
using SimpleIdServer.IdServer.Template.Startup.Conf.Migrations.AfterDeployment;
using SimpleIdServer.IdServer.Template.Startup.Conf.Migrations.BeforeDeployment;
using SimpleIdServer.IdServer.Template.Startup.Configurations;
using SimpleIdServer.IdServer.Template.Startup.Consumers;
...
namespace SimpleIdServer.IdServer.Template.Startup.Conf;
