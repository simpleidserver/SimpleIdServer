...
{
    public class CredentialProofRequestConverter : JsonConverter<CredentialProofRequest>
    {
        public override CredentialProofRequest Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var result = new CredentialProofRequest();
            ...
            while (continueToRead && reader.Read())
            {
                switch (reader.TokenType)
                {
                    ...
                    case JsonTokenType.String:
                        ...
                        else result.Parameters.Add(propertyName, reader.GetString());
                        break;
                }
            }
        ...
        public override void Write(Utf8JsonWriter writer, CredentialProofRequest value, JsonSerializerOptions options)
        {
