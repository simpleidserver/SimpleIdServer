        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssertionExpirationTimeInSeconds = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "RelyingPartyClaimMapping",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserAttribute = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClaimName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClaimFormat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RelyingPartyAggregateId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelyingPartyClaimMapping", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RelyingPartyClaimMapping_RelyingParties_RelyingPartyAggregateId",
                        column: x => x.RelyingPartyAggregateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelyingPartyClaimMapping_RelyingPartyAggregateId",
                table: "RelyingPartyClaimMapping",
                column: "RelyingPartyAggregateId");
