BEGIN
	...
	DECLARE attr_mapping_cursor CURSOR FOR SELECT [Id], [SourceResourceType], [TargetResourceType], [TargetAttributeId], [SourceAttributeId] from [dbo].[SCIMAttributeMappingLst] where SourceResourceType = 'Groups' and TargetResourceType = 'Users';
